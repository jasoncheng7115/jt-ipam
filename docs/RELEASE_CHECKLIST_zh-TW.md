...
提交前自問 11 項（即 docs/SECURITY_zh-TW.md §11 心智清單，照表打勾）：
...
- [ ] `docs/SPEC_zh-TW.md` Phase 進度章節更新到位
- [ ] `README.md` 沒提到不存在的功能
...
- [ ] 有 breaking change？INSTALL_zh-TW.md「升級」段有寫到？
- [ ] 增加新環境變數？INSTALL_zh-TW.md §3 表格有列？
...
# 或：用部署前的 pg_dump 整個還原（見 INSTALL_zh-TW.md §5「還原」段）
