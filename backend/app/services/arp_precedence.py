...
ARP_SOURCES = ("manual", "scanner", "opnsense", "pfsense", "windows_dhcp", "librenms", "adguard", "proxmox")
# 預設：手動最優先，其次主動掃描、防火牆 ARP、LibreNMS、AdGuard、Proxmox
DEFAULT_ARP_ORDER: list[str] = ["manual", "scanner", "opnsense", "pfsense", "windows_dhcp", "librenms", "adguard", "proxmox"]
_TTL = 60.0
